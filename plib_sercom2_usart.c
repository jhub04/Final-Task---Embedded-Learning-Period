...
void __attribute__((used)) SERCOM2_0_Handler (void) 
{
    SERCOM2_USART_InterruptHandler();
}

void __attribute__((used)) SERCOM2_1_Handler (void) 
{
    SERCOM2_USART_InterruptHandler();
}

void __attribute__((used)) SERCOM2_2_Handler (void) 
{
    SERCOM2_USART_InterruptHandler();
}

void __attribute__((used)) SERCOM2_OTHER_Handler (void) 
{
    SERCOM2_USART_InterruptHandler();
}
